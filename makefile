...
DRECK_BUNDLED_MARKERS = $(addprefix ./persistent/libraries-with-extracted-bundles/, ${DRECK_PLUGIN_NAMES})
...
ifneq ($(filter-out ${DRECK_BUNDLED_MARKERS}, $(shell find ./persistent/libraries-with-extracted-bundles -mindepth 1)),)
		rm $(filter-out ${DRECK_BUNDLED_MARKERS}, $(shell find ./persistent/libraries-with-extracted-bundles -mindepth 1))
endif
endif
